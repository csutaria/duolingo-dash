...
| `fullSync(cycleAll=false)`                     | ①, ③, ⑤, ⑦             | No                        | profile, all course XP snapshots, XP daily history, active course skills+mistakes, achievements |
