...
- Sync: null-safe XP summary mapping, avatar URL handling, legacy `language_data` key resolution, path-derived skill progress overlay with stored word-map fallback.
